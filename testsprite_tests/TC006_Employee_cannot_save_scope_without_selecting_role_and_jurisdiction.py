...
async def run_test():
    ...
    try:
        ...
        # -> Fill the Aadhaar input with a valid 12-digit number and click 'Request OTP Verification'.
        ...
        # -> Enter the mock OTP '123456' into the OTP input (index 101) and click 'Confirm Identity' (index 105) to continue to the scope setup screen.
        ...
        # -> Click 'Save Scope & Access Dashboard' (element 153) while leaving selections empty, then verify a validation error appears and the dashboard is not shown.
