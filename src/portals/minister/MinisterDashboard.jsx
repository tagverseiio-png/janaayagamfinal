...
import { ShieldAlert, Landmark, AlertTriangle, Users, Star, Flame, CheckCircle, Clock, Map, Radio } from 'lucide-react';
...
export default function MinisterDashboard({ deptView = false }) {
 ...
 activeTab === 'grid'
 ? 'bg-[#9a0002] text-white shadow-sm'
 : 'text-slate-600 hover:text-[#9a0002]'
 }`}
 >
 ...
 <div className="flex items-center gap-2 text-[#9a0002] ">
 ...
 >
 <div className="mb-4">
 <h3 className="text-lg font-black text-[#9a0002] uppercase tracking-wide">
