...
export default function BulkActions() {
 ...
 className="text-[10px] font-black uppercase text-[#8B1A1A] hover:text-[#8B1A1A] transition-colors"
 >
 ...
 value=""
 className="bg-slate-50 border-none outline-none py-2.5 px-3 text-[10.5px] font-black uppercase text-slate-600 cursor-pointer"
 >
 ...
 <div 
 key={ticket.id} 
 className="flex items-start gap-4 p-4 bg-white border border-slate-200 rounded-3xl shadow-sm hover:border-[#8B1A1A]/40 transition-all cursor-pointer"
 ...
 className="flex-1 py-3 rounded-xl bg-[#8B1A1A] hover:bg-[#8B1A1A] text-white font-extrabold text-xs uppercase transition-colors shadow-md flex items-center justify-center gap-1"
 >
