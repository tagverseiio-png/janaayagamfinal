...
export default function LocationSettings() {
  ...
  return (
    <div className="pb-24">
      {/* Page Title Header */}
      <div className="bg-white p-4 border-b border-slate-200/60 shadow-sm shrink-0 flex items-center gap-3">
        <button 
        ...
        <div>
          ...
          <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">
            {tLabel("Aadhaar vs Current Residence", "ஆதார் மற்றும் தற்போதைய முகவரி")}
          </p>
        </div>
      </div>
            ...
            <div className="space-y-4">
              ...
              <div className="pt-2 border-t border-slate-200/60 space-y-2">
                ...
                <button
                  ...
                  className="w-full bg-[#8B1A1A]/5 hover:bg-[#8B1A1A]/10 text-[#8B1A1A] border border-[#8B1A1A]/20 font-extrabold text-[11px] py-2.5 rounded-xl flex items-center justify-center gap-1.5 transition-all"
                >
            ...
            <form onSubmit={handleSaveLivingLocation} className="space-y-4">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="w-full bg-white hover:bg-slate-50 text-[#8B1A1A] border border-[#8B1A1A]/30 font-extrabold text-xs py-3 rounded-xl shadow-sm transition-all flex items-center justify-center gap-2 select-none"
                >
                  {gpsDetecting ? (
                    <>
              ...
              <button
                ...
                className="w-full text-white font-extrabold text-xs py-3.5 rounded-xl shadow-md hover:opacity-95 transition-all flex items-center justify-center gap-2 select-none"
              >
