...
import { ShieldAlert, Landmark, AlertTriangle, Users, Star, Flame, CheckCircle, Clock, MapPin, X, ArrowRight, ShieldCheck, Map, Radio } from 'lucide-react';
...
export default function CmDashboard({ overviewMode = false }) {
 ...
 colorClass = 'bg-emerald-50 border-emerald-250 hover:bg-emerald-100';
 ...
 <div className="absolute top-0 right-0 -mt-6 -mr-6 w-24 h-24 bg-slate-100 rounded-full blur-xl opacity-20"></div>
 ...
 <h1 className="text-2xl sm:text-3xl font-black text-[#8B1A1A] mt-1 leading-none">
 {headingText}
 </h1>
 </div>
 </div>
 ...
 >
 <span className="text-[10px] font-black uppercase tracking-wider truncate text-slate-800 ">
 {dist.name}
 </span>
 ...
 className="relative w-full max-w-md bg-white h-full shadow-2xl p-6 overflow-y-auto border-l border-slate-200 flex flex-col justify-between"
 >
 ...
 <div className="bg-slate-50 p-4 rounded-2xl border flex justify-between items-center shadow-inner">
 <div>
 ...
 <div key={taluk.name} className="bg-white p-4 border rounded-2xl shadow-sm space-y-2">
 <div className="flex justify-between items-center border-b pb-2">
 <span className="text-xs font-black text-slate-850 ">{taluk.name} Taluk</span>
